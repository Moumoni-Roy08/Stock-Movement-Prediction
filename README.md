...
# Data Scrapping from Telegram
The following code describes how to scrape data, preprocess and store as CSV file.
...
api_hash = 'yyyyyyyyyyyyyyyyyyyyyyy'  # Replace with your API Hash
...
channel_username = 'abababababababaababa'  # Replace with the channel's username
