...
api_id = 'yyyyyyy'  # Replace with your API ID
api_hash = 'kyghjfbhjgfhjkhgfbgbhjkhg'  # Replace with your API Hash
...
channel_username = 'jfghjkgfd'  # Replace with the channel's username
